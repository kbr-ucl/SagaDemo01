        ...
        static async Task Main(string[] args)
        {
            ...
            var builder = new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddDbContext<SampleBatchDbContext>(x => x.UseSqlServer(hostContext.Configuration.GetConnectionString("sample-batch"), b => b.MigrationsAssembly("SampleBatch.Service")));
